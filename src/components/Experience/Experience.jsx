      ...
      >
         <ul className="flex flex-col gap-[24px] w-full lg:w-[407px]">
            <li className="flex items-center gap-[16px] bg-red-600 p-[20px] lg:w-[407px] lg:h-[80px] cursor-pointer">
               <CarIcon />
               <h3 className="lg:text-[24px] text-[20px] font-bold text-white">
                  Диагностика
               </h3>
            </li>
         ...
         <div className="lg:w-[432px] ">
            ...
            <div onClick={() => setIsFormActive(true)} className="inline-flex items-center gap-4 cursor-pointer hover:bg-red-500 transition-all bg-red-600 py-[10px] px-[38px] lg:py-[20px] lg:px-[48px] mt-[25px]">
